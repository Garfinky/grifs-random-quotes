...
const getTweetUrl = (quote: string, author: string): string => {
    ...
    <div className='background' style={{ backgroundColor: randomColor, transition }}>
      <div id="quote-box" style={{color: randomColor, transition}}>
        ...
        <div className="buttons">
          <a id="tweet-quote" style={{backgroundColor: randomColor, marginRight: "10px", transition }} href={getTweetUrl(quote.quote, quote.author)} target="_blank" rel="noopener noreferrer">
